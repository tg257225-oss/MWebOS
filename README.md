...
## Features
Currently, MOs features 3 different draggable windows. 
### Calculator
...
All windows can be closed with the 'x' in the upper right. They can be opened (and closed) by clicking the buttons on the taskbar.
